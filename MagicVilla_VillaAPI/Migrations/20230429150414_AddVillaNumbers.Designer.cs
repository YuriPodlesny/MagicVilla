...
namespace MagicVilla_VillaAPI.Migrations
{
    ...
    [Migration("20230429150414_AddVillaNumbers")]
            ...
            modelBuilder.Entity("MagicVilla_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 4, 29, 20, 4, 14, 262, DateTimeKind.Local).AddTicks(3800),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 4, 29, 20, 4, 14, 262, DateTimeKind.Local).AddTicks(3812),
                            Details = "Located in Havelock Island, 500 metres from Govind Nagar Beach, Royal Villa Beach Resort provides accommodation with a garden, free private parking and a restaurant. This 3-star hotel offers room service and a concierge service. The hotel features garden views and a children's playground.",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 4, 29, 20, 4, 14, 262, DateTimeKind.Local).AddTicks(3814),
                            Details = "Located in Havelock Island, 500 metres from Govind Nagar Beach, Royal Villa Beach Resort provides accommodation with a garden, free private parking and a restaurant. This 3-star hotel offers room service and a concierge service. The hotel features garden views and a children's playground.",
                        ...
                        new
                        {
                            Id = 4,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 4, 29, 20, 4, 14, 262, DateTimeKind.Local).AddTicks(3816),
                            Details = "Located in Havelock Island, 500 metres from Govind Nagar Beach, Royal Villa Beach Resort provides accommodation with a garden, free private parking and a restaurant. This 3-star hotel offers room service and a concierge service. The hotel features garden views and a children's playground.",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "",
                            CreateDate = new DateTime(2023, 4, 29, 20, 4, 14, 262, DateTimeKind.Local).AddTicks(3818),
                            Details = "Located in Havelock Island, 500 metres from Govind Nagar Beach, Royal Villa Beach Resort provides accommodation with a garden, free private parking and a restaurant. This 3-star hotel offers room service and a concierge service. The hotel features garden views and a children's playground.",
